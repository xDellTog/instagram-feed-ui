...
const lightTheme = createTheme({
    colors: {
        ...
        primary: grass.grass10,
        primaryTint: grass.grass9,
        primaryShade: grass.grass11,
...
const darkTheme = createTheme({
    colors: {
        ...
        primary: grassDark.grass10,
        primaryTint: grassDark.grass9,
        primaryShade: grassDark.grass11,
